...
@section('content')
	...
	<body id="kt_body">
							...
							<div class="card card-flush">
								...
								<div class="card-header align-items-center py-5 gap-2 gap-md-5">
									...
									<div class="card-toolbar flex-row-fluid justify-content-end gap-5">
										...
										<!--begin::Add product-->
										<a href=""  data-bs-toggle="modal" data-bs-target="#exampleModal"   class="btn btn-primary">Add category</a>
										<!--end::Add product-->
									</div>
									<!--end::Card toolbar-->
								</div>
								...
								<div class="card-body pt-0">
									<!--begin::Table-->
									<table class="table  align-middle table-row-dashed fs-6 gy-5 data-table-category" id="kt_ecommerce_products_table">
										<!--begin::Table head-->
										<thead>
											<!--begin::Table row-->
		...
		<div class="modal-dialog">
		  <div class="modal-content">
		         <div class="modal-body">
			       <form id="SubmitFormCategory"  enctype="multipart/form-data">
                    @csrf
			         <div class="card">
				    		<div class="card-body">
							   	<div id="wizard1">
										<section>
											<h2 class="d-none">category Information</h2>
		...
		<div class="modal-dialog">
		  <div class="modal-content">
		         <div class="modal-body">
			       <form id="SubmitFormUpdateCategory"  enctype="multipart/form-data">
                    @csrf
			         <div class="card">
				    		<div class="card-body">
							   	<div id="wizard1">
										<section>
											...
											<div class="control-group form-group">
            	                           	<label class="form-label">active</label>
 												<input type="text"  id = "active" name="active" class="form-control required" placeholder="active">
                                                <span class=" text-danger" role="alert" >
                                                <i class="fas fa-exclamation-circle mr-1" id ="activeError"  hidden></i>
                                                </span>
                                            </div>
                                            ...
                                            <button type="button" id = "close_update_form" class="btn-close" data-bs-dismiss="modal" aria-label="Close" hidden ></button>
									</section>
                                    </div>
                                </div>
                        </div>
	...
	<script src='assets/js/custom/actions/category-actions.js'></script>
