...
@section('content')
							...
							<div class="card card-flush">
								...
								<div class="card-header align-items-center py-5 gap-2 gap-md-5">
									...
									<div class="card-toolbar flex-row-fluid justify-content-end gap-5">
										...
										<!--begin::Add product-->
										<a href=""  data-bs-toggle="modal" data-bs-target="#exampleModal"   class="btn btn-primary">Add  books</a>
										<!--end::Add product-->
									</div>
									<!--end::Card toolbar-->
								</div>
								...
								<div class="card-body pt-0">
									<!--begin::Table-->
									<table class="table  align-middle table-row-dashed fs-6 gy-5 data-table-books" id="kt_ecommerce_products_table">
										<!--begin::Table head-->
										<thead>
											<!--begin::Table row-->
											<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                                ...
                                                <th class="min-w-100px">auther </th>
                                                <th class="min-w-100px">category</th>
												<th class="min-w-100px">details</th>
												<th class="min-w-100px">price</th>
                                                <th class="min-w-100px">date</th>
                                                <th class="min-w-100px">create</th>
   ...
   <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog">
		  <div class="modal-content">
		         <div class="modal-body">
			       <form id="SubmitFormBooks"  enctype="multipart/form-data">
                    @csrf
			         <div class="card">
				    		<div class="card-body">
							   	<div id="wizard1">
										<section>
											<h2 class="d-none">books Information</h2>
											<div class="control-group form-group">
            	                           	<label class="form-label">name</label>
											   <input type="text"  id = "name" name="name" class="form-control required" placeholder="Name">

                                                 <span class=" text-danger" role="alert" >
                                                <i class="fas fa-exclamation-circle mr-1" id ="nameError"  hidden></i>
                                                </span>
                                            </div>	
											<div class="control-group form-group">
            	                           	<label class="form-label">author</label>
 												<input type="text"  id = "author" name="author" class="form-control required" placeholder="author">
                                                <span class=" text-danger" role="alert" >
                                                <i class="fas fa-exclamation-circle mr-1" id ="authorError"  hidden></i>
                                                </span>
                                            </div>
											<div class="control-group form-group">
											<label class="form-label">category </label>
												<div class="w-100 mw-150px">
												@if(!empty($categories))
													<select class="form-select form-select-solid"   data-control="select2" name ="category_id" id = "category_id" data-hide-search="true" data-placeholder="category" data-kt-ecommerce-product-filter="category">
												 ...
												 @endif	
												<span class=" text-danger" role="alert" >
                                                <i class="fas fa-exclamation-circle mr-1" id ="categoryError"  hidden></i>
                                                </span>
												</div>
											</div>
												<div class="control-group form-group">
            	                           	<label class="form-label">date of publication</label>
 												<input  type="datetime-local" id = "date" name="date" class="form-control required" placeholder="date_of_publication">
                                                <span class=" text-danger" role="alert" >
                                                <i class="fas fa-exclamation-circle mr-1" id ="dateError"  hidden></i>
                                                </span>
                                            </div>
											<div class="control-group form-group">
            	                           	<label class="form-label">details</label>
 												<input type="text"  id = "details" name="details" class="form-control required" placeholder="details">
                                                <span class=" text-danger" role="alert" >
                                                <i class="fas fa-exclamation-circle mr-1" id ="detailsError"  hidden></i>
                                                </span>
                                            </div>
											<div class="control-group form-group">
            	                           	<label class="form-label">price</label>
 												<input type="text"  id = "price" name="price" class="form-control required" placeholder="price">
                                                <span class=" text-danger" role="alert" >
                                                <i class="fas fa-exclamation-circle mr-1" id ="priceError"  hidden></i>
                                                </span>
                                            </div>
											<div class="control-group form-group">
												<label class="form-label">image</label>
												<input type="file" id = "image" class="form-control require"  name="image" placeholder="image">
                                                <span class=" text-danger" role="alert" >
                                                <i class="fas fa-exclamation-circle mr-1" id ="imageError"  hidden></i>
                                                </span>
                                            </div>  
		...
		<div class="modal fade" id="modelUpdateBooks" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog">
		  <div class="modal-content">
		         <div class="modal-body">
			       <form id="SubmitFormBooksUpdate"  enctype="multipart/form-data">
                    @csrf
			         <div class="card">
				    		<div class="card-body">
							   	<div id="wizard1">
										<section>
											...
											<div class="control-group form-group">
            	                           	<label class="form-label">name</label>
											   <input type="text"  id = "id" name="id" class="form-control required" placeholder="id" hidden>
 												<input type="text"  id = "nameUpdate" name="name" class="form-control required" placeholder="Name">
												 <span class=" text-danger" role="alert" >
                                                <i class="fas fa-exclamation-circle mr-1" id ="nameError"  hidden></i>
                                                </span>               
                                            </div>	
											<div class="control-group form-group">
            	                           	<label class="form-label">author</label>
 												<input type="text"  id = "authorUpdate" name="author" class="form-control required" placeholder="author">
												 <span class=" text-danger" role="alert" >
                                                <i class="fas fa-exclamation-circle mr-1" id ="authorError"  hidden></i>
                                                </span>
                                            </div>
											...
											<label class="form-label">category </label>
												<div class="w-100 mw-150px">
												@if(!empty($categories))
													<select class="form-select form-select-solid"   data-control="select2" name ="category_id" id = "categoryUpdate" data-hide-search="true" data-placeholder="category" data-kt-ecommerce-product-filter="category">
													@foreach($categories as $item)
												    	<option></option>
														<option value="-1"> </option>
														<option value="{{$item->id}}">{{$item->name}}</option>
												...
												<div class="control-group form-group">
            	                           	<label class="form-label">date of publication</label>
 												<input  type="datetime-local" id = "dateUpdate" name="date" class="form-control required" placeholder="date_of_publication">
												 <span class=" text-danger" role="alert" >
                                                <i class="fas fa-exclamation-circle mr-1" id ="dateError"  hidden></i>
                                                </span>
                                            </div>
											<div class="control-group form-group">
            	                           	<label class="form-label">details</label>
 												<input type="text"  id = "detailsUpdate" name="details" class="form-control required" placeholder="details">
												 <span class=" text-danger" role="alert" >
                                                <i class="fas fa-exclamation-circle mr-1" id ="detailsError"  hidden></i>
                                                </span>
                                            </div>
											<div class="control-group form-group">
            	                           	<label class="form-label">price</label>
 												<input type="text"  id = "priceUpdate" name="price" class="form-control required" placeholder="price">
												 <span class=" text-danger" role="alert" >
                                                <i class="fas fa-exclamation-circle mr-1" id ="priceError"  hidden></i>
                                                </span>
                                            </div>
                                            ...
                                            <button type="button" id = "close_form_update_book" class="btn-close" data-bs-dismiss="modal" aria-label="Close" hidden ></button>
									</section>
                                    </div>
                                </div>
                        </div>
	...
	@endpush
     		<!-- in this page  -->
	    <script src='assets/js/custom/actions/books-actions.js'></script>
